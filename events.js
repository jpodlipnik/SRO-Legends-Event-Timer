...
const EVENTS = [
    ...
    { id: 8,  name: "Battle Arena (Flag)",      times: ["12:00", "19:00"],                                       days: [0, 1, 2, 3, 4, 5, 6] },
    { id: 9,  name: "Survival Arena",           times: ["10:00", "22:00"],                                       days: [0, 1, 2, 3, 4, 5, 6] },
    { id: 10, name: "Special Goods Time",       times: ["09:00", "15:00", "21:00"],                              days: [1, 2, 3, 4, 5, 6] },
    { id: 11, name: "Special Goods Time",       times: ["09:00", "15:00"],                                       days: [0] },
    { id: 12, name: "Last Man Standing",        times: ["10:30", "22:30"],                                       days: [0, 1, 2, 3, 4, 5, 6] },
    { id: 13, name: "War of Leagues",           times: ["20:00"],                                                days: [0, 1, 2, 3, 4, 5, 6] },
    { id: 14, name: "Tower Defense",            times: ["17:30"],                                                days: [0, 5, 6] },
    { id: 15, name: "Guild Wars",               times: ["20:30"],                                                days: [0] },
    ...
    { id: 19, name: "Thief Special Goods",      times: ["23:00"],                                                days: [0, 1, 2, 3, 4, 5, 6] }
];
